...
public class VideoSeriesAdapter extends BaseAdapter {
	private final String TAG = VideoSeriesAdapter.class.getSimpleName();
	Context context;
	ArrayList<Video> data;
	int curIndex;

	public VideoSeriesAdapter(Context context, ArrayList<Video> data) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (video.getIndex() == curIndex) {
			...
			mViewHolder.txt_tv_series.setBackgroundResource(R.drawable.tv_series2);
			mViewHolder.txt_tv_series.setTextColor(context.getResources().getColor(R.color.gray_ababab));
		}
